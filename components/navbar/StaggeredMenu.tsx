  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className={`staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[2em] pointer-events-none z-20 transition-colors ${
            open ? "bg-white" : "bg-navbar-bg"
          }`}
            ...
            >
              {items && items.length ? (
                items.map((it, idx) => (
                  ...
                  >
                    <Link
                      className="sm-panel-item relative text-black font-semibold text-4xl lg:text-[5.5rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]"
                      href={it.link}
                ...
                <li
                  ...
                  aria-hidden="true"
                >
                  <span className="sm-panel-item relative text-black font-semibold text-4xl lg:text-[5.5rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]">
                    <span className="sm-panel-itemLabel inline-block [transform-origin:50%_100%] will-change-transform">
                      No items
                    </span>
                  </span>
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2em; background: var(--color-navbar-bg, #061e34); pointer-events: none; z-index: 20; transition: background-color 0.3s ease; }
.sm-scope .staggered-menu-wrapper[data-open] .staggered-menu-header { background: white; }
.sm-scope .staggered-menu-header > * { pointer-events: auto; }
.sm-scope .sm-logo { display: flex; align-items: center; user-select: none; }
.sm-scope .sm-logo-img { display: block; height: 32px; width: auto; object-fit: contain; }
.sm-scope .sm-toggle { position: relative; display: inline-flex; align-items: center; gap: 0.5rem; background: transparent; border: none; cursor: pointer; color: #e9e9ef; font-weight: 500; line-height: 1; overflow: visible; font-size: 1rem; }
...
@media (min-width: 1024px) { .sm-scope .sm-panel-item { font-size: 5.5rem; } }
